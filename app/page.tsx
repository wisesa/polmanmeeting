...
type HomeSearchParams = Promise<{ date?: string | string[] }>;
...
export default async function HomePage(context: { searchParams?: HomeSearchParams }) {
    ...
    <main className="appShell">
      <section className="heroPanel homeHeroPanel">
        ...
        <div className="heroContent">
          <div>
            <p className="eyebrow light">Polman Meeting</p>
            <h1 className="heroTitle">Absensi Meeting</h1>
            <p className="heroSubtitle">
              Pilih jadwal rapat dari daftar, buka detail meeting, lalu lakukan absensi wajah melalui browser.
            </p>
          </div>
